...
export default function Cheese({ data, selectedData, setSelectedData, category, categories, setCategory, selCategory }) {
    const [selectedBase, setSelectedBase] = useState(selectedData?.cheese);
